...
const SLIDES = [
  {
    ...
    text: "Записывай настроение, привычки и сны — приложение покажет, в каких сферах жизни у тебя всё хорошо, а где стоит обратить внимание.",
    visual: "🧠",
    color: "text-primary",
    bg: "bg-primary/10",
  },
  {
    ...
    text: "Твой Глиф — живой символ, который меняется вместе с тобой. Чем активнее ты действуешь, тем ярче он становится. Забросишь — потускнеет.",
    visual: "◈",
    color: "text-accent",
    bg: "bg-accent/10",
  },
  {
    ...
    title: "Расти вместе с другими",
    text: "Делись успешными привычками, вступай в группы единомышленников и вдохновляйся прогрессом других. Вместе проще.",
    visual: "👥",

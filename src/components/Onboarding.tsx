...
const SLIDES = [
  ...
  },
  {
    ...
    title: "AI диагностирует паттерны",
    text: "Алгоритм анализирует твоё настроение, энергию и привычки — находит взаимосвязи и назначает протоколы, которые ломают прокрастинацию.",
    visual: "⚡",
    color: "text-accent",
    bg: "bg-accent/10",
  },
